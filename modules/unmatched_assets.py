...
# This is a modified version of the original script by Drazzilb, Version: 4.1.8
# you can find the original script here: https://github.com/Drazzilb08/userScripts/blob/master/python-scripts/unmatched-asset.py
# ===================================================================================================
...
config = Config(script_name="unmatched_assets")
...
def print_output(unmatched_movies, unmatched_series, unmatched_collections, media_movies, media_series, plex_collections):
    ...
    if unmatched_series:
        ...
        logger.info(
            f"\t{unmatched_series_total} unmatched series & {unmatched_seasons} unmatched seasons. Grand percent complete: ({100 - 100 * (unmatched_series_total + unmatched_seasons) / (total_series + total_seasons):.2f}% of grand total {total_series + unmatched_seasons}).\n")
